...
<!-- 导航栏 -->
		...
		<?php
			...
			$sql = "SELECT * FROM publish where user_id='$user_id' order by id desc;";
    		...
    		// 输出数据
	    		while($row = mysqli_fetch_assoc($res)) {
			        ...
			        if($myid==$user_id){
			        echo				'<a href="http://bbs.yiwangchunyu.wang/delete.php?id='.$id.'" class="card-link">删除</a>';
			   		...
			   		echo		'<form action="comment.php" method="post" enctype="multipart/form-data" class="form-inline ">
			   						...
			   						<input type="hidden" name="fromid" value="'.$user_id.'">  
	...
	?>
		 ...
		 <div class="card" style="margin-top: 10px">
		    <div class="card-body">
		        <h4 class="card-title">师大记忆</h4>
		        <div class="row">  
           			<div class="form-inline">  
           				<div class="" style="margin-left:10px; margin-right: 10px">
           					<img src="http://bbs.yiwangchunyu.wang/img/profilephoto/boy.jpg" class="rounded-circle " style="width:40px; height:40px；" alt="头像"> 
           				</div>
           				<div>
           					<h5><a href="http://bbs.yiwangchunyu.wang/profile.php?userid=22">BBS</a>&nbsp &nbsp<small>2018-06-06 21:00</small></h5> 
           				</div>
				...
				<div class="media mt-4">
		    		<img src="http://bbs.yiwangchunyu.wang/img/ecnu.jpg" class="align-self-center mr-4" style="width:200px; height:150px">
		    		<div class="media-body">
		      			<p class="card-text text-dark">点击导航栏的发布按钮，赶快来发个帖吧！</p>
		    		</div>
		   		</div>
		   		<div class="" style="padding-top: 10px">
		   			<a href="#" class="card-link" >阅读全文</a>
		        	<a href="#" class="card-link">赞(99+)</a>
		   		</div>
		    </div>
		 </div>
